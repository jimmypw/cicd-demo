...
export POSTGRES_USER_B64="$(echo -n \"${POSTGRES_USER}\" | base64)"
export POSTGRES_DB_B64="$(echo -n \"${POSTGRES_DB}\" | base64)"
export MM_SQLSETTINGS_DATASOURCE_B64="$(echo -n \"${MM_SQLSETTINGS_DATASOURCE}\" | base64)"
